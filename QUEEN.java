...
//هذا الكود يعبر عن كلاس الكوين في الشطرنح والكلاس يرث من البيس واكيد يحتوي على وظائف لحساب الحركات القانونية للقطعة في البورد او تاللوحة وادارة الحركات المسبقة 
...
//يعني ان كلاس الكويين نهائي ولا يمكن توريثه ويمتد من كلاس بيس
public final class Queen extends Piece {

    //هذه مصفوفة تخزن الازاحات الممكنة للحركات القانونية للكوين على اللوحة
    private final static int[] CANDIDATE_MOVE_COORDINATES = { -9, -8, -7, -1, 1,
            7, 8, 9 };

    //هنا الماب الي نخزن المرشحين المحسوبين مسبقا للحركات القانونية وللمعلومية نحن نتحدث عن متغيرات وثوابت هنا
    private final static Map<Integer, MoveUtils.Line[]> PRECOMPUTED_CANDIDATES = computeCandidates();

    
    //تعريف منشئين لكلاس الكوين 
    //الأول يستدعي المنشئ الأصلي مع تحديد أنها الحركة الاولى والثاني يسمح بتحديد ما اذا كانت الحركة الاولى ام لا، والثاني
    ...
    //هنا فانكشن لحساب المرشحين وهذه الطريقة تقوم بحساب وتخزين المرشحين للحركات القانونية لكل موضع على اللوحة 
...
//هنا امر اوفر رايد ليحسب ويعيد الحركات القانونية الممكنة بالكوين
    @Override
...
//هنا الاستثناءات الخاصة بالاعمدة 
